...
public class UICamera : MonoBehaviour
{
    ...
    private bool isWaitDoubleClick = false;
    ...
    private IEnumerator ClickDelay(GameObject pressed)
    {
				...
				if (currentTouch.clickNotification != ClickNotification.None && currentTouch.pressed == currentTouch.current)
				{
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        StartCoroutine(ClickDelay(currentTouch.pressed));
                    }
