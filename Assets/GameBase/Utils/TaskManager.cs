...
namespace GameBase
{
    ...
    public class Task
    {
        ...
        /// upon construction.
        public Task(IEnumerator c,Action<bool> callBack, bool autoStart = true)
        {
            task = TaskManager.CreateTask(c,callBack);
    ...
    public class TaskManager : MonoBehaviour
    {
        public class TaskState
        {
           ...
           // public event FinishedHandler Finished;
            ...
            public TaskState(IEnumerator c,Action<bool> callBack)
            {
                coroutine = c;
        ...
        public static TaskState JSCreateTask(params  object[] @params)
        {
           // CoroutineFactory.GenerateCoroutine(@params);
           return CreateTask(CoroutineFactory.GenerateCoroutine(@params), (@bool) => { });
        }

     //   public static TaskState CreateTask(IEnumerator coroutine,Action<bool> callBack)
        // modify by zyc adpter w
        public static TaskState CreateTask(IEnumerator coroutine, Action<bool> callBack)
        {
            if (singleton == null)
            {
            ...
            return new TaskState(coroutine, callBack);
        }
