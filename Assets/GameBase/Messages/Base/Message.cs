...
namespace GameBase
{
    ...
    {
        public const int FilterTypeNothing = -1;
        /// <summary>
        /// Enumeration for the message type. We use strings so they can
        /// be any value.
        /// </summary>
        protected int mType = Message.FilterTypeNothing;
        public int Type
        {
            get { return mType; }
            set { mType = value; }
        ...
        /// </summary>
        protected int mRecipient = Message.FilterTypeNothing;
        ...
        {
            mType = Message.FilterTypeNothing;
            mSender = null;
            mRecipient = Message.FilterTypeNothing;
            mData = null;
            mIsSent = false;
            mIsHandled = false;
            mDelay = 0.0f;
